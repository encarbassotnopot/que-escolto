/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0ff029bfdae358d8ca34530dceb9eb32)
// Runtime types generated with workerd@1.20250416.0 2025-04-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		ENVIRONMENT: "prod" | "debug" | "local";
		SPOTIFY_CLIENT_ID: string;
		SPOTIFY_CLIENT_SECRET: string;
		SPOTIFY_CLIENT_ENDPOINT: string;
		MY_AUTH_CODE: string;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SPOTIFY_CLIENT_ID" | "SPOTIFY_CLIENT_SECRET" | "SPOTIFY_CLIENT_ENDPOINT" | "MY_AUTH_CODE">> {}
}
